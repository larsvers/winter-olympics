...
function makeVisLabel() {
  ...
  function my(selection) {
    ...
    // console.log('selection', selection.node(), 'canvas', canvas.node(), 'labelDim', labelDim, 'canvasDim', canvasDim, 'canvasPos', canvasPos, 'padding', padding)
...
function makeMultipleButton() {
  ...
  function my(selection) {
    ...
    // console.log('selection', selection.node(), 'canvas', canvas.node(), 'buttonDim', buttonDim, 'canvasDim', canvasDim, 'canvasPos', canvasPos, 'padding', padding)
...
function timeGreeting() {
  ...
  if (hour< 5) d3.select('#time-greeting').html('Good, well, evening and welcome to a little data <span class="modest">hi</span>story of the Winter Olympics.');
  if (hour>= 5 && hour< 12) d3.select('#time-greeting').html('Good morning and welcome to a little data <span class="modest">hi</span>story of the Winter Olympics.');
  if (hour>= 12 && hour< 18) d3.select('#time-greeting').html('Good afternoon and welcome to a little data <span class="modest">hi</span>story of the Winter Olympics.');
  if (hour>= 18 && hour<= 23) d3.select('#time-greeting').html('Good evening and welcome to a little data <span class="modest">hi</span>story of the Winter Olympics.');
