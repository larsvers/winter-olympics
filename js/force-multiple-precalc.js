				...
				function initLabels(){
					...
					var t = d3.timer(function(elapsed){
						...
						if (elapsed > 150) {
							...
							// console.log(event, 'canvasPos', canvasPos, 'canvasDim', canvasDim, 'headerDim', headerDim, 'footerDim', footerDim, '\n--------------------------------------------------\n ')
							// console.log(event, 'top', canvasPos.top, 'left', canvasPos.left, '\n--------------------------------------------------\n ')
