	...
	function chart(selection) {
		...
		function my(selection) {
			...
			selection.each(function (data, i) {
				...
				// console.log(data.nations_grid[event]);
				// console.log(data.events_force[event]);
				...
				d3.select('.main-canvas#' + event).on('mousemove', function() {
					...
					// console.log('canvasPos.top', canvasPos.top, 'tipDim.height', tipDim.height, 'arrowDim', arrowDim)
					...
					// console.log(hiddenCanvas.attr('id'), colKey);
					...
					if (nodeData) {
						...
						// console.log('grid-multiple', nodeData.nation, Math.round(nodeData.x), colourToNodeGrid);

						// console.log(nodeData);

						if (tipDim.height > canvasPos.top) {

							// console.log('low:', 'tipDim.height', tipDim.height, 'nodeData.y', nodeData.y);
							...
							// console.log('center:', 'tipDim.width', tipDim.width, 'nodeData.x', nodeData.x);

							// console.log('tipDim.width/2', tipDim.width/2, 'nodeData.x', nodeData.x, 'central');
							// console.log('node position within canvas', nodeData.y,'\n + canvas position relative to window', Math.round(canvasPos.top),'\n - height of tooltip', tipDim.height,'\n - border-width of triangle', arrowDim);
